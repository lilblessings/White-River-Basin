export const getLiveDataUrl = () =>
  `https://raw.githubusercontent.com/lilblessings/White-River-Basin-Dam-Water-Levels/main/live.json`;

export const getHistoricalDataUrl = (damName: string) =>
  `https://raw.githubusercontent.com/lilblessings/White-River-Basin-Dam-Water-Levels/main/historic_data/${damName.replace(/\s+/g, '_')}.json`;
